...
class profile_define_brregservice extends profile_define_base {
    ...
    public function define_form_specific($form) {
        $form->addElement('text', 'organization-number', get_string('organization-number', 'profilefield_brregservice'));
        $form->setType('organization-number', PARAM_INT);
